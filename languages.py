...
LANGUAGES = {
    'en': {
        ...
        # Main menu
        'main_menu': '🚀 I3lani - Your Personal Profit Engine\n\nCrypto advertising made easy. Start building your reach and earning exposure today.\n\nWhat would you like to do?',
        ...
        'my_ads': '📊 My Campaigns',
        'pricing': '📊 Choose Your Earnings Window', 
        'share_earn': '🎯 Invite 3 friends and unlock a FREE 1-day ad campaign! Let others fuel your reach while you earn passively.',
        'settings': '⚙️ Your Settings',
        'help': '🛠 Need help? I\'m here to help you make the most out of your ad strategy and crypto marketing journey!',
        ...
        'select_duration': '📊 Choose your earnings window: The more days you run, the more exposure you gain. Your content. Your traffic. Your profit.',
        'choose_payment': '💎 Pay with TON or Telegram Stars – fast, borderless, and crypto-friendly. Your campaign starts the moment you confirm.',
        ...
        'payment_confirmed': '✅ Ad scheduled! 🚀 Your offer is now being shown to crypto-conscious audiences. Expect traffic, messages, and real results.',
...
Questions? Use /support to get help!""",
    ...
    'ar': {
        ...
        # Welcome and start
        'welcome': '👋 مرحباً بك في بوت I3lani – محرك الأرباح الشخصي الخاص بك. ابدأ في نشر الإعلانات للمجموعات المستهدفة واكسب الرؤية والعملاء المحتملين وحركة المرور الجاهزة للعملات الرقمية — من 0.29 دولار فقط يومياً.',
        'choose_language': '🌐 اختر لغتك للبدء:',
        'language_selected': '✅ اللغة: العربية 🇸🇦',
        'language_changed': '✅ ممتاز! تم تحديث اللغة للعربية.',
        
        # Main menu
        'main_menu': '🚀 I3lani - محرك الأرباح الشخصي الخاص بك\n\nإعلانات العملات الرقمية أصبحت سهلة. ابدأ في بناء وصولك وكسب التعرض اليوم.\n\nماذا تريد أن تفعل؟',
        ...
        'my_ads': '📊 حملاتي',
        'pricing': '📊 اختر نافذة أرباحك', 
        'share_earn': '🎯 ادعُ 3 أصدقاء واحصل على حملة إعلانية مجانية لمدة يوم واحد! دع الآخرين يغذون وصولك بينما تكسب بشكل سلبي.',
        'settings': '⚙️ إعداداتك',
        ...
        'select_duration': '📊 اختر نافذة أرباحك: كلما زادت الأيام التي تشغلها، زادت التعرض الذي تحصل عليه. محتواك. حركة المرور الخاصة بك. ربحك.',
        'choose_payment': '💎 ادفع بـ TON أو Telegram Stars – سريع، بلا حدود، وصديق للعملات الرقمية. حملتك تبدأ فور التأكيد.',
        ...
        # Payment confirmation
        'payment_confirmed': '✅ تم جدولة الإعلان! 🚀 عرضك يُعرض الآن للجماهير المهتمة بالعملات الرقمية. توقع الزيارات والرسائل والنتائج الحقيقية.',
...
أسئلة؟ استخدم /support للحصول على المساعدة!""",
    ...
    'ru': {
        ...
        # Welcome and start
        'welcome': '👋 Добро пожаловать в I3lani Bot – ваш персональный двигатель прибыли. Начните публиковать рекламу в целевых группах и получайте видимость, лиды и криптоготовый трафик — от всего $0.29 в день.',
        'choose_language': '🌐 Выберите язык для начала:',
        'language_selected': '✅ Язык: Русский 🇷🇺',
        'language_changed': '✅ Отлично! Язык обновлен на русский.',
        
        # Main menu
        'main_menu': '🚀 I3lani - Ваш персональный двигатель прибыли\n\nКриптореклама стала простой. Начните увеличивать охват и получать экспозицию сегодня.\n\nЧто вы хотите сделать?',
        ...
        'my_ads': '📊 Мои кампании',
        'pricing': '📊 Выберите окно заработка', 
        'share_earn': '🎯 Пригласите 3 друзей и получите БЕСПЛАТНУЮ рекламную кампанию на 1 день! Пусть другие подпитывают ваш охват, пока вы зарабатываете пассивно.',
        ...
        'select_duration': '📊 Выберите окно заработка: Чем больше дней вы запускаете, тем больше экспозиции получаете. Ваш контент. Ваш трафик. Ваша прибыль.',
        'choose_payment': '💎 Платите TON или Telegram Stars – быстро, без границ и дружелюбно к криптовалютам. Ваша кампания начнется в момент подтверждения.',
        ...
        # Payment confirmation
        'payment_confirmed': '✅ Реклама запланирована! 🚀 Ваше предложение теперь показывается криптосознательным аудиториям. Ожидайте трафик, сообщения и реальные результаты.',
