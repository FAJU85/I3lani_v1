...
LANGUAGES = {
    'en': {
        ...
        'pay_ton': '💎 TON Cryptocurrency',
        'payment_instructions': '💳 **Payment Instructions**',
        'memo_format': '📝 Payment Reference: {memo}',
...
Questions? Use /support to get help!""",
    ...
    'ar': {
        ...
        # Ad creation
        'send_ad_content': '📝 **أنشئ إعلانك**\n\nارفع محتواك:\n• 📝 رسالة نصية\n• 📸 صورة مع وصف\n• 🎥 فيديو مع وصف\n\nأرسل محتواك الآن:',
        'ad_received': '✅ تم استلام المحتوى بنجاح!',
        'choose_channels': '📢 اختر قنوات الإعلان:',
        'select_duration': '⏱️ **اختر مدة الحملة**\n\nحدد المدة التي تريد أن يعمل إعلانك خلالها:',
